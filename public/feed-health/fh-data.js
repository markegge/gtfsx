...
(function () {
  ...
  const STATES = [
    ...
    S("06","CA","California","West",209,79,25,19,7),
    S("08","CO","Colorado","West",48,83,16,5,41),
    ...
    S("12","FL","Florida","South",72,74,41,14,0),
    S("13","GA","Georgia","South",83,18,25,8,0),
    S("15","HI","Hawaii","West",4,100,0,33,0),
    S("16","ID","Idaho","West",14,71,20,20,0),
    ...
    S("36","NY","New York","Northeast",77,88,13,13,0),
    ...
    S("45","SC","South Carolina","South",26,54,29,14,0),
    ...
    S("53","WA","Washington","West",57,84,5,9,0),
